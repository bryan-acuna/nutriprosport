...
const CategoryFilter = () => {
  ...
  return (
    <div className="px-4 sm:px-8 pb-3 flex justify-center gap-2 overflow-x-auto whitespace-nowrap [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {categories.map((cat) => (
        <button
          key={cat}
